            ...
            <div class="layui-row">
                <form class="layui-form">
                    ...
                    <div class="layui-form-item">
                        <label for="username" class="layui-form-label">
                            <span class="x-red">*</span>启用时间
                        </label>
                        <div class="layui-input-inline">
                            <input type="datetime-local"  name="start" required="" lay-verify=""
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input type="datetime-local"  name="end" required="" lay-verify=""
                          autocomplete="off" class="layui-input">
                      </div>
                  ...
                  <div class="layui-form-item">
                      <label for="L_email" class="layui-form-label">
                          <span class="x-red">*</span>活动商品价格
                      </label>
                      <div class="layui-input-inline">
                          <input type="text" name="new_money" required="" lay-verify=""
                          autocomplete="off" class="layui-input" placeholder="商品元价格{{$v->goods_price}}">
                      </div>
                  </div>
                  <div class="layui-form-item">
