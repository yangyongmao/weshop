...
<!--[if lt IE 9]>
  ...
  <script type="text/javascript" src="/adminStatic/js/PIE/PIE_IE678.js"></script>
 <![endif]-->
<body>
 <div class="Sellerber" id="Sellerber">
 <!--顶部-->
  <div class="Sellerber_header apex clearfix" id="Sellerber_header">
   <div class="l_f logo"><img src="/adminStatic/images/logo_03.png" /></div>
   ...
   <div class="news l_f"><a href="#" class="fa  fa-bell "></a><em>5</em></div>
     <div class="administrator l_f">
       <img src="/adminStatic/images/avatar.png"  width="36px"/><span class="user-info">欢迎你,超级管理员</span><i class="glyph-icon fa  fa-caret-down"></i>
...
<!--内容-->
  ...
  <div class="show_iframe" id="show_iframe">
       <iframe scrolling="yes" class="simei_iframe" frameborder="0" src="" name="iframepage" data-href="shop_index.html"></iframe>
       </div>
      </div>
  </div>
<!--底部-->
