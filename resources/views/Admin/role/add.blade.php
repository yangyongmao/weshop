                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <table  class="layui-table layui-input-block">
                        ...
                        @foreach($data as $v)
                            <tr>
                                <td>
                                    <input type="checkbox" name="like1[write]" lay-skin="primary" lay-filter="father" title="{{$v->m_content}}">
                                </td>
                                <td>
                                    @foreach($v->child as $va)
                                    <div class="layui-input-block">
                                        <input name="n_id[]" lay-skin="primary" type="checkbox" value="{{$va->n_id}}" title="{{$va->n_remarks}}">
                                    </div>
                                    @endforeach
                                </td>
                            </tr>
