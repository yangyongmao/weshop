                    ...
                    <div class="layui-inline layui-show-xs-block">
                        <div class="layui-input-inline">
                            <input type="text" id="username" name="n_name" required="" lay-verify="required"
                                   autocomplete="off" class="layui-input" value="{{$data->n_name}}" placeholder="请填写控制器于方法名">
                        </div>
                    ...
                    <div class="layui-inline layui-show-xs-block">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="username" name="n_remarks" required="" lay-verify="required"
                                   autocomplete="off" class="layui-input" value="{{$data->n_remarks}}" placeholder="请描述控制器于方法名">
                        </div>
