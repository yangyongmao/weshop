            ...
            <form action="" method="post" class="layui-form layui-form-pane">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        autocomplete="off" class="layui-input" disabled value="{{$cat_name}}">
                    </div>
                </div>
                                ...
                                <td>
                                    <div class="layui-input-block">
                                        @foreach($standardData as $k => $v)
                                            <input lay-skin="primary" type="checkbox" title="{{$v->name}}(子级:```种)" data-id="{{$v->id}}">
                                        @endforeach
                                    </div>
                                </td>
                            </tr>
                ...
                <div class="layui-form-item">
                    <button class="layui-btn delete" lay-submit="" lay-filter="" type="button">删除此规格</button>
                </div>
            </form>
        </div>
    </div>
